...
public class DynamicWebApiOptions
{
    ...
    /// </summary>
    public List<string> RemoveControllerPostfixes { get; set; } = new() { "AppService", "ApplicationService" };
    ...
    /// </summary>
    public List<string> RemoveActionPostfixes { get; set; } = new() { "Async" };
    ...
    /// </summary>
    public Dictionary<Assembly, AssemblyDynamicWebApiOptions> AssemblyDynamicWebApiOptions { get; } = new();
    ...
    /// <summary>
    /// controller, action, realReturnType, checkResult
    /// </summary>
    public Func<TypeInfo, ActionModel, Type, bool> ConfigurationApiResult { get; set; }
    public Type                                    UnifiedResultType      { get; set; }
}