...
public static class DynamicWebApiServiceExtensions
{
    ...
    /// <returns></returns>
    public static IApplicationBuilder UseDynamicWebApi(
        this IApplicationBuilder                       application,
        Action<IServiceProvider, DynamicWebApiOptions> optionsAction
    )
    {
        ...
        AppConsts.ConfigurationApiResult       = options.ConfigurationApiResult;
        AppConsts.UnifiedResultType            = options.UnifiedResultType;
    ...
    public static IServiceCollection AddDynamicWebApiCore<TSelectController, TActionRouteFactory>(
    ...
    public static IServiceCollection AddDynamicWebApi(this IServiceCollection services, DynamicWebApiOptions options)
    {
        ...
        if (partManager == null)
        {
            throw new InvalidOperationException($"\"{nameof(AddDynamicWebApi)}\" must be after \"AddMvc\".");
        }
        ...
        services.Configure<MvcOptions>(mvcOptions =>
        {
            ...
            mvcOptions.Conventions.Add(new DynamicWebApiConvention(options.ActionRouteFactory, new DefaultSelectController()));
        });
