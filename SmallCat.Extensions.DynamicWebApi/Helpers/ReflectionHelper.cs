...
internal static class ReflectionHelper
{
    ...
    /// <returns></returns>
    public static TAttribute? GetSingleAttributeOrDefault<TAttribute>(this MemberInfo memberInfo, TAttribute defaultValue = default, bool inherit = true)
        where TAttribute : Attribute
    {
        var attributeType = typeof(TAttribute);
        return memberInfo.IsDefined(typeof(TAttribute), inherit)
            ? memberInfo.GetCustomAttributes(attributeType, inherit).Cast<TAttribute>().First()
            : defaultValue;
    }
        ...
        where TAttribute : Attribute
    {
        ...
        return type.GetTypeInfo().BaseType == null ? null : type.GetTypeInfo().BaseType.GetSingleAttributeOfTypeOrBaseTypesOrNull<TAttribute>(inherit);
    }
    ...
    public static bool IsAsyncMethod(this MethodInfo method) =>
        method.GetCustomAttribute<AsyncMethodBuilderAttribute>() != null ||
    ...
    /// <param name="method"></param>
    /// <returns></returns>
    public static Type GetRealType(this MethodInfo method) => method.IsAsyncMethod()
        ? (method.ReturnType.GenericTypeArguments.FirstOrDefault() ?? typeof(void))
        : method.ReturnType;
